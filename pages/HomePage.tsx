      ...
      {item}
        ...
        <div className="absolute top-12 right-0 w-1/2 h-full pointer-events-none hidden lg:block">
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <div className="hero-visual relative w-full max-w-2xl">
              <div className="premium-system-visual bg-white/90 p-3 rounded-[3.5rem] shadow-[0_40px_100px_-20px_rgba(15,23,42,0.24)] border-2 border-[#c9a55c]/80 ring-1 ring-white/50 relative z-10 overflow-hidden group">
                <img
                  ...
                  alt="Senior engineering expert collaborating on a digital workplace solution"
                  className="w-full h-auto rounded-[2.8rem] object-cover aspect-[4/3] brightness-[1.01] saturate-[1.05]"
                />
                <div className="absolute left-8 top-8 z-20 flex items-center gap-4 rounded-[1.6rem] border border-slate-200 bg-white px-5 py-4 shadow-[0_18px_45px_-18px_rgba(7,21,33,.55)]">
                  <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1769e8] text-white shadow-lg shadow-blue-500/25">
                  ...
                  <span>
                    <span className="block text-xs font-black uppercase tracking-[0.14em] text-[#17233a]">Microsoft 365 Architect</span>
                    <span className="mt-1 block text-[10px] font-extrabold uppercase tracking-[0.12em] text-[#1769e8]">Founder-Led Delivery</span>
                  </span>
                </div>
              </div>
            </div>
