        ...
        <div className="absolute top-12 right-0 w-1/2 h-full pointer-events-none hidden lg:block">
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <div className="hero-visual relative w-full max-w-2xl transition-all duration-1000 transform hover:scale-[1.04] [perspective:1200px]">
              <div className="premium-system-visual bg-white/90 p-3 rounded-[3.5rem] shadow-[0_40px_100px_-20px_rgba(15,23,42,0.24)] border border-[#c9a55c]/35 relative z-10 overflow-hidden group">
                <div className="premium-system-dashboard" aria-label="Microsoft 365 transformation framework">
                  <div className="premium-system-dashboard__header">
                    <div>
                      <p>Digital Workplace Blueprint</p>
                      <strong>Operational clarity at scale</strong>
                    </div>
                    <span>LIVE</span>
                  </div>

                  <div className="premium-system-dashboard__metrics">
                    <div><strong>Less</strong><span>Manual work</span></div>
                    <div><strong>Faster</strong><span>Approval cycles</span></div>
                    <div><strong>Unified</strong><span>Governed platform</span></div>
                  </div>

                  <div className="premium-system-dashboard__flow">
                    <div><span>01</span><strong>Discover</strong><small>Process & risk</small></div>
                    <i aria-hidden="true" />
                    <div><span>02</span><strong>Architect</strong><small>Secure foundation</small></div>
                    <i aria-hidden="true" />
                    <div><span>03</span><strong>Automate</strong><small>Measurable impact</small></div>
                  </div>

                  <div className="premium-system-dashboard__platforms">
