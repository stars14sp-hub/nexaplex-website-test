          ...
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <div className="hero-visual relative w-full max-w-2xl transition-all duration-1000 transform hover:scale-[1.04] [perspective:1200px]">
              <div className="premium-system-visual bg-white/90 p-3 rounded-[3.5rem] shadow-[0_40px_100px_-20px_rgba(15,23,42,0.24)] border-2 border-[#c9a55c]/80 ring-1 ring-white/50 relative z-10 overflow-hidden group">
                ...
                />
                <div className="absolute left-8 top-8 z-20 flex items-center gap-4 rounded-[1.6rem] border border-white/80 bg-white/95 px-5 py-4 shadow-[0_18px_45px_-18px_rgba(7,21,33,.55)] backdrop-blur-md">
                  ...
                  <span>
                    <span className="block text-[11px] font-black uppercase tracking-[0.2em] text-[#17233a]">Senior Architect</span>
                    <span className="mt-1 block text-[9px] font-bold uppercase tracking-[0.18em] text-[#1769e8]">Expert Oversight</span>
                  </span>
                </div>
              </div>
            </div>
